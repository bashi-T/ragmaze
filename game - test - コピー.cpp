...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
	  ...
	  if (playerlife == 1) {
		...
		//  Novice::DrawEllipse(bulposX, bulposY, 5, 5, 0.0f, BLUE, kFillModeSolid);
		//  break;
		// }
		Novice::DrawSprite(enemyX[0], enemyY[0], enemypic[0], 2, 2, 0.0f, 0xFFFFFFFF);
		Novice::DrawSprite(enemyX[1], enemyY[1], enemypic[1], 2, 2, 0.0f, 0xFFFFFFFF);
		Novice::DrawSprite(enemyX[2], enemyY[2], enemypic[2], 2, 2, 0.0f, 0xFFFFFFFF);
		Novice::DrawSprite(enemyX[3], enemyY[3], enemypic[3], 2, 2, 0.0f, 0xFFFFFFFF);
		Novice::DrawSprite(enemyX[4], enemyY[4], enemypic[4], 2, 2, 0.0f, 0xFFFFFFFF);
		Novice::DrawSprite(enemyX[5], enemyY[5], enemypic[5], 2, 2, 0.0f, 0xFFFFFFFF);

		if (enemy1 == 1 && enemymove[0] < 51) {
			Novice::DrawSprite(
			  razorX[0], razorY[0], enemybullet[0], 1, 1, 0.0f,
			  0xFFFFFFFF);
		}
		if (enemy2 == 1 && enemymove[1]<51) {
			Novice::DrawSprite(
			  razorX[1], razorY[1], enemybullet[1], 1, 1, 0.0f,
			  0xFFFFFFFF);
		}
		if (enemy3 == 1 && enemymove[2]<51) {
			Novice::DrawSprite(
			  razorX[2], razorY[2], enemybullet[2], 1, 1, 0.0f,
			  0xFFFFFFFF);
		}
		if (enemy4 == 1 && enemymove[3] < 51) {
			Novice::DrawSprite(
			  razorX[3], razorY[3], enemybullet[3], 1, 1, 0.0f,
			  0xFFFFFFFF);
		}
		if (enemy5 == 1 && enemymove[4] < 51) {
			Novice::DrawSprite(
			  razorX[4], razorY[4], enemybullet[4], 1, 1, 0.0f,
			  0xFFFFFFFF);
		}
		if (enemy6 == 1 && enemymove[5] < 51) {
			Novice::DrawSprite(
			  razorX[5], razorY[5], enemybullet[5], 1, 1, 0.0f,
			  0xFFFFFFFF);
		}

		Novice::DrawBox(915, 0, 400, 720, 0.0f, BLACK, kFillModeSolid);
		Novice::ScreenPrintf(920, 5, "WASD or ARROW KEY:moving");
		Novice::ScreenPrintf(920, 25, "and shoot opposit direction");
		Novice::ScreenPrintf(920, 45, "enemy＝ %d score＝ %d", bustered, score);
