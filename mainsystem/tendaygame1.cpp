...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		case 1:
			...
			if (map2[mapnumber][(aiboY + aibovelY) / mapsize][(aiboX + aibovelX) / mapsize] == 3) {
				dashcount2 = 1;
			}
			...
			if (map2[mapnumber][(aiboY + aibovelY) / mapsize][(aiboX + aibovelX) / mapsize] == 13) {
				dashcount2 = 11;
			}
			...
			if (map2[mapnumber][(aiboY + aibovelY) / mapsize][(aiboX + aibovelX) / mapsize] == 23) {
				dashcount2 = 21;
			}
			...
			if (map2[mapnumber][(aiboY + aibovelY) / mapsize][(aiboX + aibovelX) / mapsize] == 33) {
				dashcount2 = 31;
			}
