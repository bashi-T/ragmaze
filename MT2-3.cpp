...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Novice::DrawQuad(
		  rotatedLeftTop.x, rotatedLeftTop.y * (-1) + kWorld, rotatedRightTop.x,
		  rotatedRightTop.y * (-1) + kWorld, rotatedLeftBottom.x,
		  rotatedLeftBottom.y * (-1) + kWorld, rotatedRightBottom.x,
		  rotatedRightBottom.y * (-1) + kWorld, 0, 0, 200, 100, square, 0xFFFFFFFF);
